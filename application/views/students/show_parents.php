                            ...
                            <tbody>
                                <?php foreach ($parent_data as $parent) { ?>
                                    <tr>
                                        ...
                                        <td> <?php echo $parent['parent_mobile']; ?> </td>
                                        <td> <?php echo $parent['parent_email']; ?> </td>
                                        <td>
                                            <form action="<?php echo base_url(); ?>students/delete_student" method="post" id="delete_student_row_<?php echo $parent['uid']; ?>" style="float:left"> 
                                                <input type="hidden" value="<?php echo $parent['uid']; ?>" name ="uid"/>
                                                <button type="button" onclick="delete_student('delete_student_row_<?php echo $parent['uid']; ?>')" class="btn red-mint"><i class="icon icon-trash"></i></button> 
                                            </form>
                                            <form action="<?php echo base_url(); ?>students/edit_student" method="post" id="edit_student_row_<?php echo $parent['uid']; ?>"  style="float:left"> 
                                                <input type="hidden" value="<?php echo $parent['uid']; ?>" name ="uid"/>
                                                <button type="button" onclick="edit_student('edit_student_row_<?php echo $parent['uid']; ?>')" class="btn green-haze"><i class="icon icon-pencil"></i></button>
                                            </form>
                                        </td>
                                    </tr>
                                <?php } ?>
