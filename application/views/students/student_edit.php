            ...
            <div class="col-md-12">
                ...
                <div class="portlet light portlet-fit portlet-form bordered">
                    ...
                    <div class="portlet-body">
                        <!-- BEGIN FORM-->
                        <form action="<?php echo base_url(); ?>students/update_student" method="post" id="student_add_form">
                            <div class="form-body">
                                ...
                                <div class="form-group form-md-line-input form-md-floating-label">
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="parent_name" value="<?php echo $user_data->parent_name; ?>">
                                        <label for="form_control_1">Parent Name</label>
                                        <span class="input-group-addon">
                                            <i class="fa fa-envelope"></i>
                                        </span>
                                    </div>
                                ...
                                <div class="form-group form-md-line-input form-md-floating-label">
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="parent_mobile" value="<?php echo $user_data->parent_mobile; ?>">
                                        <label for="form_control_1">Parent Mobile No</label>
                                        <span class="input-group-addon">
                                            <i class="fa fa-envelope"></i>
                                        </span>
                                    </div>
                                ...
                                <div class="form-group form-md-line-input form-md-floating-label">
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="parent_email" value="<?php echo $user_data->parent_email; ?>">
                                        <label for="form_control_1">Parent Email</label>
                                        <span class="input-group-addon">
                                            <i class="fa fa-envelope"></i>
                                        </span>
                                    </div>
                                </div>
                                <input type="hidden" name="uid" value="<?php echo $user_data->uid; ?>">
                            </div>
