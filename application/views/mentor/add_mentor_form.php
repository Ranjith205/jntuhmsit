            ...
            <div class="col-md-12">
                <!-- BEGIN VALIDATION STATES-->
                    ...
                    <div class="portlet-title">
                        ...
                        <div class="actions">
                            <form action="<?php echo base_url(); ?>mentors/mentors_list" method="post"  id="add_student">
                                <div class="btn-group btn-group-devided" >
                                    <button type="submit" class="btn purple-plum">View Mentors</button>
                                </div>
                            </form>
                        </div>
                    </div>
                    <div class="portlet-body">
                        <!-- BEGIN FORM-->
                        <form action="<?php echo base_url(); ?>mentors/save_mentor" method="post" id="mentors_add_form">
                            <div class="form-body">
